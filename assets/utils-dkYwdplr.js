...
const Nn = { render: Pn },
            ...
            e.showIcon
              ? (g(),
                v(
                  ...
                  { key: 0 },
                  [
                    z(q(Dn), { class: "group-hover:hidden" }),
                    z(q(Nn), { class: "hidden group-hover:block" }),
                  ],
                  64
                ))
              : J("", !0),
  ...
  He = Je(In, [["__scopeId", "data-v-87c60b70"]]),
  Ln = ["href"],
  fe = Oe({
    __name: "CommonLink",
    props: {
            ...
            [
              ...
              t.href.startsWith("/")
                ? (g(),
                  V(
                    o,
                    { key: 1, to: t.href, class: oe(t.class), onClick: n },
                    { default: W(() => [Ae(r.$slots, "default")]), _: 3 },
                    8,
                    ["to", "class"]
                  ))
                : J("", !0),
...
const dr = { render: ur },
  ...
  fr = l(
    "circle",
    { cx: "13.431", cy: "13", r: "12", stroke: "currentColor" },
    null,
    -1
  ),
  pr = l(
    "path",
    { stroke: "currentColor", d: "m2.937 19.374 22.842-7.284" },
    null,
    -1
  ),
  mr = [fr, pr];
...
const _r = { render: wr },
  ...
  br = l(
    ...
    [
      l("clipPath", { id: "a" }, [
        l("path", { fill: "#fff", d: "M0 0h24v24H0z" }),
      ]),
    ],
    -1
  ),
...
const Br = { render: Mr },
  ...
  Nr = Ke(
    '<g stroke="currentColor" stroke-linejoin="round" stroke-miterlimit="10" clip-path="url(#a)"><path d="M23.92 24.948h-8.477L5 14.62V0h18.92z"></path><path d="M5 14.62h10.443v10.328M8.875 4.836h11.168M8.875 7.834h11.168M8.875 10.833h11.168"></path></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h27v27H0z"></path></clipPath></defs>',
    2
  ),
  jr = [Nr];
function Ir(e, t) {
...
const ss = { render: rs },
  ...
  os = {
    class:
      "flex mx-auto w-full max-w-7xl items-center justify-between h-12 md:h-16",
  },
  is = we(() => l("img", { src: Kt, alt: "", class: "w-9 h-9" }, null, -1)),
  as = we(() => l("span", { class: "text-2xl font-title" }, "Glacier", -1)),
  cs = [is, as],
  ls = { class: "w-28" },
  us = {
    class:
      "hidden md:flex items-center h-[62px] rounded-full nav-wrap px-6 gap-6",
  },
  ds = ["onMouseenter"],
  hs = { class: "w-12 flex items-center justify-center" },
  fs = { class: "flex-1 overflow-hidden" },
  ps = { class: "font-tag relative" },
  ...
  As = we(() =>
    l(
      ...
      {
        class:
          "flex text-xs px-2 py-1 bg-maintext rounded-full text-black mr-2",
      },
      "Mainnet",
      -1
    )
  ...
  Ss = we(() =>
    l("div", { class: "absolute w-full h-full bg-mainbg" }, null, -1)
  ),
  $s = { class: "px-5 py-[86px]" },
  Es = { class: "mobile-drop" },
  ks = { class: "mobile-menu" },
  Os = ["onClick"],
  Ds = { key: 0, class: "mobile-group" },
  Cs = { class: "font-tag" },
  Rs = { class: "text-white/80 text-xs" },
  Ts = Oe({
    __name: "Header",
    setup(e) {
      const t = [
        ...
        r = st(!1),
        s = () => {
          (r.value = !1), window.scrollTo({ top: 0 });
        };
      return (o, i) => {
          ...
          v(
            ...
            [
              l(
                ...
                {
                  class: oe([
                    "px-5 py-3 left-0 top-1 right-0 z-20 bg-black/20 backdrop-blur-sm md:bg-transparent md:backdrop-blur-0",
                    { absolute: !r.value, fixed: r.value },
                  ]),
                },
                [
                  l("div", os, [
                            ...
                            [
                              z(
                                fe,
                                {
                                  href: f.href,
                                  class:
                                    "flex items-center gap-1 text-sm font-title text-gray-400 hover:text-white",
                                },
                                {
                                  default: W(() => [
                                    l(
                                          ...
                                          (d) => (
                                            ...
                                            V(
                                              fe,
                                              {
                                                href: d.href,
                                                class:
                                                  "flex items-center gap-3 opacity-70 hover:opacity-100",
                                              },
                                              {
                                                default: W(() => [
                                                  l("div", hs, [
                            ...
                            l("div", ks, [
                              z(
                                fe,
                                {
                                  href: f.href,
                                  class:
                                    "flex items-center gap-1 w-full py-1 justify-center text-sm font-title text-gray-500 hover:text-white",
                                },
                                {
                                  default: W(() => [
                                    l(
...
const Zs = { render: Qs },
  ...
  Xs = { key: 0, class: "mx-5 md:mx-auto" },
  eo = { class: "w-full max-w-7xl medias-wrap px-5 py-8" },
  to = De(() =>
    l(
      "div",
      ...
      [
        l("div", null, [
          pe("Built by "),
          l("span", { class: "linear-text" }, "Developers"),
        ]),
        l("div", null, [
          pe("for "),
          l("span", { class: "linear-text" }, "Developers"),
  ...
  no = { class: "flex items-center gap-5 md:gap-7 mt-7" },
  ro = ["href"],
  so = { class: "flex flex-col justify-end footer-wrap" },
  oo = { class: "footer-content" },
  io = {
    class:
      "w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-5 md:gap-16",
  },
  ao = { class: "w-full max-w-[340px]" },
  co = De(() =>
    l(
      "div",
      { class: "text-white/80" },
      " Glacier is building the first Data-centric Blockchain to supercharging AI at scale ",
      -1
    )
  ),
  lo = {
  ...
  uo = { class: "flex flex-col md:flex-row gap-5 md:gap-16" },
  ho = { class: "flex flex-col items-start gap-1.5 md:gap-3" },
  fo = { class: "uppercase group-title mb-2" },
  po = {
    class:
      "w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-2 md:gap-16 text-white/80 mt-12 md:mt-24",
  },
  mo = { class: "flex-1" },
  wo = De(() =>
    l("a", { href: "", class: "hover:underline" }, "Privacy Policy", -1)
  ),
  _o = De(() =>
    l("a", { href: "", class: "hover:underline" }, "Terms of use", -1)
  ),
  go = Oe({
    __name: "Footer",
    setup(e) {
        ...
        n = [
          {
            title: "Products",
            items: [
              { title: "GlacierDB on Arweave", href: "/ar" },
              { title: "GlacierDB on Greenfield", href: "/bnb" },
              { title: "GlacierDB on Filecoin", href: "/filecoin" },
              { title: "GlacierAI", href: "/ai" },
              { title: "GlacierDA", href: "/da" },
            ],
          },
          {
            title: "Resources",
      ...
      return (r, s) => {
        ...
        return (
          ...
          v(
            ...
            null,
            [
              (i = (o = r.$route) == null ? void 0 : o.path) != null &&
              i.startsWith("/dataset")
                ? J("", !0)
                : (g(),
                  v("div", Xs, [
                    l("div", eo, [
                            ...
                            (c, f) => (
                              ...
                              v(
                                "a",
                                {
                                  ...
                                  target: "_blank",
                                  class:
                                    "flex w-14 h-14 md:w-20 md:h-20 items-center justify-center rounded-full cursor-pointer border border-white/20 text-white hover:bg-[#57FCFF] hover:text-black",
                                },
                                [(g(), V(Ue(t[f])))],
                                8,
                                ro
                    ...
                    l("div", ao, [
                      ...
                      l("a", lo, [
                        z(
                          He,
                          { "show-icon": "" },
                          { default: W(() => [pe("Start building")]), _: 1 }
                        ),
                      ]),
                    ]),
                    l("div", uo, [
                                ...
                                (f) => (
                                  ...
                                  V(
                                    fe,
                                    {
                                      href: f.href,
                                      class:
                                        "text-white/80 hover:underline text-sm md:text-base",
                                    },
                                    {
  ...
  Gi = Je(go, [["__scopeId", "data-v-78c1e9d9"]]);
function At(e, t) {
  return function () {
...
const To = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  ut = "0123456789",
  Ct = { DIGIT: ut, ALPHA: je, ALPHA_DIGIT: je + je.toUpperCase() + ut },
...
function Me(e, t, n) {
  ...
  function w(_) {
    ...
    return a.isArrayBuffer(_) || a.isTypedArray(_)
  ...
  function d(_, b, T) {
    ...
    if (_ && !T && typeof _ == "object") {
      if (a.endsWith(b, "{}"))
        ...
        (a.isArray(_) && ei(_)) ||
        ((a.isFileList(_) || a.endsWith(b, "[]")) && (P = a.toArray(_)))
      )
        return (
          (b = Mt(b)),
          P.forEach(function (L, Pe) {
            !(a.isUndefined(L) || L === null) &&
              t.append(
                i === !0 ? dt([b], Pe, o) : i === null ? b : b + "[]",
                w(L)
              );
          }),
          !1
  ...
  function C(_, b) {
    if (!a.isUndefined(_)) {
      ...
      u.push(_),
        a.forEach(_, function (P, G) {
          (!(a.isUndefined(P) || P === null) &&
            s.call(t, P, a.isString(G) ? G.trim() : G, b, D)) === !0 &&
            C(P, b ? b.concat(G) : [G]);
        }),
        u.pop();
    }
...
function Pt(e, t, n) {
  ...
  if (
    (s
      ? (o = s(t, n))
      : (o = a.isURLSearchParams(t) ? t.toString() : new Qe(t, n).toString(r)),
    o)
  ) {
    const i = e.indexOf("#");
    i !== -1 && (e = e.slice(0, i)),
...
const Nt = {
  ...
  ii = {
    isBrowser: !0,
    classes: { URLSearchParams: ri, FormData: si, Blob: oi },
    protocols: ["http", "https", "file", "blob", "url", "data"],
  },
  jt = typeof window < "u" && typeof document < "u",
  ai = ((e) => jt && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
    ...
    return (
      ...
      f
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = hi(s[i])),
          !c)
    );
  }
...
class Be {
  ...
  set(t, n, r) {
    ...
    function o(c, f, w) {
      ...
      (!u || s[u] === void 0 || w === !0 || (w === void 0 && s[u] !== !1)) &&
        (s[u || f] = $e(c));
    }
...
`);
  ...
  static accessor(t) {
    const r = (this[pt] = this[pt] = { accessors: {} }).accessors,
      s = this.prototype;
    function o(i) {
      const c = he(i);
      r[c] || (yi(s, i), (r[c] = !0));
...
a.reduceDescriptors(Be.prototype, ({ value: e }, t) => {
...
const Si = K.hasStandardBrowserEnv
  ? (function () {
  ...
  Oi =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        u.open(e.method.toUpperCase(), Pt(D, e.params, e.paramsSerializer), !0),
          (u.timeout = e.timeout);
        function C() {
          if (!u) return;
          const b = Z.from(
        ...
        if (
          ...
          K.hasStandardBrowserEnv &&
            (c && a.isFunction(c) && (c = c(e)), c || (c !== !1 && Si(D))))
        ) {
          const b =
            e.xsrfHeaderName && e.xsrfCookieName && xi.read(e.xsrfCookieName);
          b && o.set(e.xsrfHeaderName, b);
        }
        s === void 0 && o.setContentType(null),
          "setRequestHeader" in u &&
            a.forEach(o.toJSON(), function (T, P) {
  ...
  Ut = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !Di(n) && ((r = Ge[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
function _t(e) {
  return (
    ...
    Ut.getAdapter(e.adapter || Xe.adapter)(e).then(
      function (r) {
        return (
          Fe(e),
          (r.data = Le.call(e, e.transformResponse, r)),
      ...
      function (r) {
        return (
          Lt(r) ||
            ...
            r &&
              r.response &&
              ((r.response.data = Le.call(e, e.transformResponse, r.response)),
...
const gt = (e) => (e instanceof Z ? { ...e } : e);
function ae(e, t) {
  t = t || {};
  const n = {};
  function r(w, d, u) {
    return a.isPlainObject(w) && a.isPlainObject(d)
      ? a.merge.call({ caseless: u }, w, d)
      : a.isPlainObject(d)
      ? a.merge({}, d)
      : a.isArray(d)
      ? d.slice()
  ...
  for (; s-- > 0; ) {
    ...
    if (i) {
      const c = e[o],
        f = c === void 0 || i(c, o, e);
      if (f !== !0)
        throw new $("option " + o + " must be " + f, $.ERR_BAD_OPTION_VALUE);
      continue;
    }
    if (n !== !0) throw new $("Unknown option " + o, $.ERR_BAD_OPTION);
  }
}
const qe = { assertOptions: Ci, validators: et },
  ee = qe.validators;
class ke {
  constructor(t) {
    (this.defaults = t),
...
function zt(e) {
  ...
  return (
    a.extend(n, Ee.prototype, t, { allOwnKeys: !0 }),
...
async function qi() {
  const [e, t] = await Promise.all([
      fetch(`${Pi}/global/stats`),
      fetch(`${Ni}/global/stats`),
    ]),
    [n, r] = await Promise.all([e.json(), t.json()]),
    s = n;
...
async function Li(e) {
  const t = Array.from(new Set(e)),
    n = t.map((o) =>
      O.get(`https://api.prd.space.id/v1/getName?tld=bnb&address=${o}`)
    ),
  ...
  return (
    r.forEach((o, i) => {
      ...
      (c = o.data) != null &&
        c.name &&
        (s[t[i]] = { type: "space", owner: t[i], domain: o.data.name });
    }),
    s
  );
}
...
async function Fi(e, t) {
  const n = e.split("."),
    { data: r } = await O.post(`${ji}/data/v1/action/find`, {
      namespace: n[0],
      dataset: n[1],
      collection: n[2],
      filter: {},
  ...
  (function (n, r) {
    ...
    var n = 1e3,
      ...
      Pe = {
        ...
        p: function (x) {
          return (
            { M: u, y: C, w: d, d: w, D: _, h: f, m: c, s: i, ms: o, Q: D }[
              x
            ] ||
            String(x || "")
              .toLowerCase()
    ...
    (E.l = be),
      (E.i = Ne),
      (E.w = function (x, m) {
        return M(x, { locale: m.$L, utc: m.$u, x: m.$x, $offset: m.$offset });
      });
    var xe = (function () {
        function x(h) {
          (this.$L = be(h.locale, null, !0)),
            this.parse(h),
            (this.$x = this.$x || h.x || {}),
            (this[nt] = !0);
        }
        ...
        return (
          ...
          (m.startOf = function (h, y) {
            var p = this,
              ...
              k = function (re, I) {
                var X = E.w(
                  p.$u ? Date.UTC(p.$y, I, re) : new Date(p.$y, I, re),
                  p
                );
              ...
              R = function (re, I) {
                return E.w(
                  p
                    ...
                    [re].apply(
                      p.toDate("s"),
                      (A ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(I)
                    ),
                  p
                );
              },
          ...
          (m.$set = function (h, y) {
            ...
            if (A === u || A === C) {
              ...
              B.$d[k](R),
                B.init(),
                (this.$d = B.set(_, Math.min(this.$D, B.daysInMonth())).$d);
            } else k && this.$d[k](R);
...
function ra(e) {
  return (
    (e = Number(e)),
    e.toString().length === 10 && (e *= 1e3),
    Hi(e).format("YYYY/MM/DD")
  );
}
export {
  He as B,
